...
| [016](016-streaming-ingress-trace-assembly.md) | Streaming ingress and trace assembly | **Accepted — S1 schema foundation implemented in PR #24; S2–S5 pending.** S1 adds the schema-1.1 evidence contracts, version-aware validation, streaming lifecycle/loss derivation, bounded record validation, safe additive-field preservation, and genuine schema-1.0 compatibility. Provider decoding, streaming assembly, persistence-policy integration, and ingress wiring remain scoped to the later accepted implementation slices. |
