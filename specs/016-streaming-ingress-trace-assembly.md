...
The accepted roadmap is implemented incrementally. PR #24 supplies the S1
schema foundation and PR #25 supplies the S2 persistence policy; S3–S5 remain
pending.
...
PR #24, S2 is implemented in PR #25, and S3 is implemented; S4–S5 remain
pending.**
